...
import { TaskPanelNew } from '@/components/TaskPanelNew';
...
export default function GamePage() {
  ...
  // 显示加载页面
  if (!imagesLoaded) {
    return <LoadingScreen onLoadComplete={() => setImagesLoaded(true)} />;
  }
        ...
        <div className="container max-w-4xl relative z-10">
          <div className="grid grid-cols-5 gap-2">
            ...
            <Dialog open={tasksOpen} onOpenChange={setTasksOpen}>
              ...
              <DialogContent className="max-w-md w-[90vw] p-0 gap-0 max-h-[75vh] mb-16" showCloseButton={true}>
                <TaskPanelNew
                  dailyTasks={DAILY_TASKS.map((task) => {
                    ...
                    return {
                      ...
                      claimed: gameState.completedTasks.includes(task.id),
                    };
                  })}
                  achievementTasks={ACHIEVEMENT_TASKS.map((task) => {
